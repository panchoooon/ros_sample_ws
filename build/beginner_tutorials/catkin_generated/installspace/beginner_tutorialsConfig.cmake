...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/guest/usr/github/ros_practice_ws/install/${idir}'.  Ask the maintainer 'guest <guest@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/guest/usr/github/ros_practice_ws/install/lib;/home/guest/usr/github/ros_practice_ws/devel/lib;/opt/tmc/ros/indigo/lib;/opt/ros/indigo/lib)
